...
export function QuotationPage() {
    return (
        <Layout>
            ...
            <li>Hãy gọi điện hoặc gửi email (<><a className="text-blue-500" href="mailto:nhamaytontheptamduccuong@gmail.com">nhamaytontheptamduccuong@gmail.com</a></>) cho chúng tôi ngay hôm nay để được tư vấn miễn phí và nhận báo giá nhanh chóng!</li>
        </ul>
        </Layout>
    );
}
